                      ...
                      p(
                        bslib::layout_sidebar(
                          sidebar = bslib::accordion(
                            bslib::accordion_panel("Getting Started",
                                                   shiny::fluidRow(
                                                     shiny::column(12,
                                                                   actionButton(NS(id, "input_data_formatting"), "Input Data Format", width = "100%",
                                                                                style = "background-color: #95a5a6; border-color: #2c3e50; margin-top:2px; margin-bottom:2px"),
                                                                   actionButton(NS(id, "load_data_files"), "Load Data Files", width = "100%",
                                                                                style = "background-color: #95a5a6; border-color: #2c3e50; margin-top:2px; margin-bottom:2px"),
                                                                   actionButton(NS(id, "load_example_data"), "Load Example Data", width = "100%",
                                                                                style = "background-color: #95a5a6; border-color: #2c3e50; margin-top:2px; margin-bottom:2px"),
                                                                   actionButton(NS(id, "load_app_overview"), "App Overview", width = "100%",
                                                                                style = "background-color: #95a5a6; border-color: #2c3e50; margin-top:2px; margin-bottom:2px"),
                                                                   actionButton(NS(id, "load_cohort_overview"), "Cohort Overview", width = "100%",
                                                                                style = "background-color: #95a5a6; border-color: #2c3e50; margin-top:2px; margin-bottom:2px"),
                                                                   actionButton(NS(id, "TimeToEvent_Tutorial"), "Time-To-Event Analysis", width = "100%",
                                                                                style = "background-color: #95a5a6; border-color: #2c3e50; margin-top:2px; margin-bottom:2px"),
                                                                   )
                                                   )
                            )#,
